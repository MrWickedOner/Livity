...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DT8m_g3H.js");
...
const manifest = {
  "ed9e0b62e19345253bb81dfb20bac27bb23001205689ad75c3f2879c99c299c4": {
    functionName: "getBusinessName_createServerFn_handler",
    importer: () => import("./assets/index-Dws7QG_8.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CsWl_KXd.js").then((n) => n.r),
